...
public interface Server<T> extends Closeable {
    ...
    public static <T> Server<T>  threadPerClient(
        ...
        return new BaseServer<T>(port, protocolFactory, encoderDecoderFactory, dataBase) {
            @Override
    ...
    public static <T> Server<T> reactor(
            ...
            Supplier<MessageEncoderDecoder<T>> encoderDecoderFactory,
            Data<T> dataBase) {
        return new Reactor<T>(nthreads, port, protocolFactory, encoderDecoderFactory, dataBase);
    }
